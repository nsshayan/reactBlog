        ...
        return (
          <form id="signupForm"  className="text-center" >
            ...
            <div className="container col-lg-4 col-lg-offset-4">
              ...
              <br />
              <div className="input-group">
                <button id="cancelSignup" onClick={this.onCancelSignup.bind(this)} className="btn btn-warning " type="button"> Cancel </button>
                <button id="signup" onClick={this.onSignup.bind(this)} className="btn btn-success ">Submit</button>
              </div>
            </div>
          </form>
        );
