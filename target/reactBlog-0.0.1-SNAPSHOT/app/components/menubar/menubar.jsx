        ...
        return (
          <div className="container-fluid">
            <div className="navbar-header">
              ...
              <a className="navbar-brand" href="#home" id="homeMenu" onClick={this.onHome.bind(this)}> CMAD </a>
            </div>
            <div className="collapse navbar-collapse" id="myNavbar">
                ...
                <ul className="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#signup" id="signupMenu" ><span className="glyphicon glyphicon-user"></span> Sign up</a></li>
                    <li><a href="#signin" id="signinMenu"><span className="glyphicon glyphicon-log-in"></span> Sign in</a></li>
                    <li><a href="#signout" id="signoutMenu" onClick={this.onSignout.bind(this)} style={hideStyle} ><span className="glyphicon glyphicon-log-in"></span> Sign out</a></li>
                </ul>
            </div>
          </div>
        );
