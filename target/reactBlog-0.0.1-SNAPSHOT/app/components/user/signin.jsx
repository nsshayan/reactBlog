      ...
      return (
        <form id="signinForm"  className="text-center">
          ...
          <div className="container  col-lg-4 col-lg-offset-4">
            ...
            <br />
           <div className="input-group">
                <button id="cancelSignin" onClick={this.onCancelSignin.bind(this)} className="btn btn-warning glyphicon glyphicon-remove cancelbtn" type="button"> </button>
                <button id="signin"  onClick={this.onSignin.bind(this)} className="btn btn-success glyphicon glyphicon-log-in" > </button>
           </div>
          </div>
        </form>
      );
