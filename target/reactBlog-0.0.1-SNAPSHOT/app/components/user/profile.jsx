        ...
        return (
            <form id="profileForm"  className="text-center">
                ...
                <div className="container col-lg-4 col-lg-offset-4">
                    ...
                    <br />
                   <div className="input-group">
                        <button id="cancelProfile" onClick={this.onCancelProfileUpdate.bind(this)} className="btn btn-warning glyphicon glyphicon-remove" type="button"> </button>
                        <button id="profile" onClick={this.onProfileUpdate.bind(this)} className="btn btn-success glyphicon glyphicon-save"> </button>
                   </div>
                   <br />
                </div>
