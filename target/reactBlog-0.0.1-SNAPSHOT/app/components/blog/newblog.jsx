        ...
        return (
            <form id="newBlogForm" className="text-left">
                ...
                <div className="container  col-lg-4 col-lg-offset-4">
                    ...
                    <div>
                        <input id="nblogTitle" placeholder="New blog title "></input>
                        <input type="text" name="blogCategory" id="nblogCategory" placeholder="Category"></input>
                    </div>
                    <br />
                    <textarea id="nblogText" className="form-control" rows="10" placeholder="blog text ..." required></textarea>
                    <br />
                    <img src="./images/linesep-short.png"  className="seperators"></img>
                    <div className="input-group">
                        <button id="cancelBlogAdd" onClick={this.onCancel.bind(this)} className="btn btn-warning glyphicon glyphicon-remove cancelbtn" type="button"> </button>
                        <button id="ncreateBlog" onClick={this.onCreate.bind(this)} className="btn btn-success glyphicon glyphicon-save" > </button>
                    </div>
                </div>
            </form>
        );
