            ...
            <form id="viewBlogForm" className="text-left">
                ...
                <div className="container  col-lg-4 col-lg-offset-4">
                    ...
                    <div>
                        ...
                        <input id="vblogTitle" style={inputStyle} readOnly></input>
                        <input type="text" id="vblogCategory" style={inputStyle} placeholder="Category" readOnly></input>
                    </div>
                    <br />
                    <input id="vblogAuthorId" style={hideStyle} readOnly></input>
                    by <input id="vblogAuthName" style={inputStyle} placeholder="Author" readOnly></input>
                    <textarea id="vblogText" className="form-control" rows="10" placeholder="blog text ..." readOnly></textarea>
                    <br />
                    <div>
                        <div>
